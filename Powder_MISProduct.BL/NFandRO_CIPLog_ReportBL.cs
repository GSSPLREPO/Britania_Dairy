...
{
    public class NFandRO_CIPLog_ReportBL
    {
        ...
        public ApplicationResult NFandRO_CIPReportData(DateTime FromDate, DateTime EndDate)
        {
            try
            {
                ...
                sSql = "usp_rpt_NF_RO_CIP_Log_Report";
