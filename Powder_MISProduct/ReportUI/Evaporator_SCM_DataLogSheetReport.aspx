<%@ Page Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="Evaporator_SCM_DataLogSheetReport.aspx.cs" Inherits="Powder_MISProduct.ReportUI.Evaporator_SCM_DataLogSheetReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Evaporator SCM Data Log Report</li>
        </ul>
    </div>
    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                        <asp:GridView ID="gvEvaporator" runat="server" GridLines="Both"
                            ...
                            OnRowCreated="gvEvaporator_SCM_DataLog_RowCreated"
