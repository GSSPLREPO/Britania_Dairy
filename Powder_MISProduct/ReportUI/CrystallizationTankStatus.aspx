<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CrystallizationTankStatus.aspx.cs" Inherits="Powder_MISProduct.ReportUI.CrystallizationTankStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Crystallization Tank Status Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10" style="font-size: 24px;">
                      Crystallization Tank Status Report
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                       <asp:GridView ID="gvCrystallizationTankStatus" runat="server" GridLines="Both" 
                        AutoGenerateColumns="true" HeaderStyle-Wrap="false"
                        Width="100%" ShowHeader="false"
                        OnRowCreated="gvCrystallizationTankStatus_RowCreated" OnPreRender="gvCrystallizationTankStatus_PreRender"
