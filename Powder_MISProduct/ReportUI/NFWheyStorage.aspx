<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="NFWheyStorage.aspx.cs" Inherits="Powder_MISProduct.ReportUI.NFWheyStorage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">NF Whey Storage Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                       <asp:GridView ID="gvNFWheyStorage" runat="server" GridLines="Both" 
                        AutoGenerateColumns="true" HeaderStyle-Wrap="false"
                        Width="100%" ShowHeader="false"
                        OnRowCreated="gvNFWheyStorage_RowCreated" OnPreRender="gvNFWheyStorage_PreRender"
