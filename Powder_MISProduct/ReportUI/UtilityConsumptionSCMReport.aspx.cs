...
{
    public partial class UtilityConsumptionSCMReport : System.Web.UI.Page
    {
        #region Page Load
        ...
        #region BindGrid
        public void BindGridUtility()
        {
            try
            {
                ApplicationResult objResult = new ApplicationResult();
                UtilityConsumptionSCMReportBL objBL = new UtilityConsumptionSCMReportBL();
                ...
                {
                    objResult = objBL.BindGridUtilitySCM(dtFromDateTime, dtToDateTime);
                    if (objResult.ResultDt.Rows.Count > 0)
                    {
                        gvUtility.DataSource = objResult.ResultDt;
                        gvUtility.DataBind();
                        // imgWordButton.Visible = imgExcelButton.Visible = true;
                        divExport.Visible = true;
                        divNo.Visible = false;
                        gvUtility.Visible = true;
        ...
        protected void gvUtility_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                if (e.Row.RowType == DataControlRowType.Header)
                {
                    ...
                    headerTableCell.RowSpan = 1;
                    //headerTableCell.ColumnSpan = 2;
                    headerTableCell.Text = "Steam Consumption (TVR+Ejector) (Kg)";
                    headerRow1.Controls.Add(headerTableCell);

                    headerTableCell = new TableHeaderCell();
                    headerTableCell.RowSpan = 1;
                    //headerTableCell.ColumnSpan = 2;
                    headerTableCell.Text = "Steam Consumption In DSI (Kg)";
                    headerRow1.Controls.Add(headerTableCell);
                    ...
                    headerTableCell.RowSpan = 1;
                    //headerTableCell.ColumnSpan = 2;
                    headerTableCell.Text = "Chilled Water (m3)";
                    headerRow1.Controls.Add(headerTableCell);

                    headerTableCell = new TableHeaderCell();
                    headerTableCell.RowSpan = 1;
                    //headerTableCell.ColumnSpan = 2;
                    headerTableCell.Text = "RO Water Inlet to Balance Tank (m3)";
                    headerRow1.Controls.Add(headerTableCell);

                    headerTableCell = new TableHeaderCell();
                    headerTableCell.RowSpan = 1;
                    //headerTableCell.ColumnSpan = 2;
                    headerTableCell.Text = "Soft Water (m3)";
                    headerRow1.Controls.Add(headerTableCell);

                    headerTableCell = new TableHeaderCell();
                    headerTableCell.RowSpan = 1;
                    //headerTableCell.ColumnSpan = 2;
                    headerTableCell.Text = "Filtered Water (m3)";
                    headerRow1.Controls.Add(headerTableCell);
                    ...
                    gvUtility.Controls[0].Controls.AddAt(0, headerRow1);
                }
            }
        }
        ...
        protected void imgPDFButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string text2 = "Utility SCM Consumption Report";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        PdfPTable pdfPTable = new PdfPTable(gvUtility.HeaderRow.Cells.Count);
                        ...
                        PdfPCell headerCell2 = new PdfPCell(new Phrase("Product Name"));
                        ...
                        PdfPCell headerCell3 = new PdfPCell(new Phrase("MCC (KW)"));
                        ...
                        PdfPCell headerCell4 = new PdfPCell(new Phrase("Total Power Consumption (KW)"));
                        ...
                        PdfPCell headerCell5 = new PdfPCell(new Phrase("Steam Consumption (TVR+Ejector) (Kg)"));
                        ...
                        PdfPCell headerCell6 = new PdfPCell(new Phrase("Steam Consumption In DSI (Kg)"));
                        ...
                        PdfPCell headerCell7 = new PdfPCell(new Phrase("Total Steam Consumption (Kg)"));
                        ...
                        PdfPCell headerCell8 = new PdfPCell(new Phrase("Chilled Water (m3)"));
                        ...
                        PdfPCell headerCell9 = new PdfPCell(new Phrase("RO Water Inlet to Balance Tank (m3)"));
                        ...
                        PdfPCell headerCell10 = new PdfPCell(new Phrase("Soft Water (m3)"));
                        ...
                        PdfPCell headerCell11 = new PdfPCell(new Phrase("Filtered Water (m3)"));
                        ...
                        PdfPCell headerCell12 = new PdfPCell(new Phrase("Compressed Air (m3)"));
                        ...
                        foreach (GridViewRow gridViewRow in gvUtility.Rows)
                        {
                        ...
                        Response.AddHeader("content-disposition", "attachment;" + "filename=Utility_SCM_Consumption_Report_" + DateTime.Now.ToString("dd/MM/yyyy") + "_" + DateTime.Now.ToString("HH:mm:ss") + ".pdf");
        ...
        protected void imgExcelButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "Utility_SCM_Consumption_Report_" + DateTime.Now.ToString("dd-MM-yyyy") + "_" + DateTime.Now.ToString("HH:mm:ss") + ".xls";
                Response.AddHeader("content-disposition", "attachment;filename=" + filename);
                Response.Cache.SetCacheability(HttpCacheability.NoCache);

                StringWriter sw = new StringWriter();
                HtmlTextWriter hw = new HtmlTextWriter(sw);
                gvUtility.AllowPaging = false;
                gvUtility.GridLines = GridLines.Both;
                foreach (TableCell cell in gvUtility.HeaderRow.Cells)
                {
                    cell.BackColor = gvUtility.HeaderStyle.BackColor;
                    count++;
                }
                ...
                foreach (GridViewRow row in gvUtility.Rows)
                {
                    ...
                    foreach (TableCell cell in row.Cells)
                    {
                        if (row.RowIndex % 2 == 0)
                        {
                            cell.BackColor = gvUtility.AlternatingRowStyle.BackColor;
                        }
                        else
                        {
                            cell.BackColor = gvUtility.RowStyle.BackColor;
                        }
                ...
                gvUtility.RenderControl(hw);
                string strSubTitle = "Utility SCM Consumption Report";
