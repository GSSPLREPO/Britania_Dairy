...
{
    public partial class MassBalanceForSMP : System.Web.UI.Page
    {
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string text2 = "Performance Qualification Report - Mass Balance Of ASMP, AWMP & DW";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        Response.AddHeader("content-disposition", "attachment;" + "filename=Mass_Balance_For_SMP_Report_" + DateTime.Now.ToString("dd-MM-yyyy") + "_" + DateTime.Now.ToString("hh:mm:ss") + ".pdf");
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "Mass_Balance_For_SMP_Report" + DateTime.Now.ToString("dd-MM-yyyy") + "_" + DateTime.Now.ToString("hh:mm:ss") + ".xls";
                ...
                //////////////////////////////////////////////////////
                string strSubTitle = "Performance Qualification Report - Mass Balance Of ASMP, AWMP & DW";
        ...
        protected void btnGo_OnClick(object sender, EventArgs e)
        {
            try
            {
                MassBalanceForSMP_Report_BL objBL = new MassBalanceForSMP_Report_BL();
                ...
                {
                    var objResult = objBL.MassBalanceReportForSMP(dtFromDateTime, dtToDateTime);
