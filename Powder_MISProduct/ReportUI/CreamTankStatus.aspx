<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CreamTankStatus.aspx.cs" Inherits="Powder_MISProduct.ReportUI.CreamTankStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Past. Cream Tank Status Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                       <asp:GridView ID="gvCreamTankStatus" runat="server" GridLines="Both" 
                        AutoGenerateColumns="true" HeaderStyle-Wrap="false"
                        Width="100%" ShowHeader="false"
                        OnRowCreated="gvCreamTankStatus_RowCreated" OnPreRender="gvCreamTankStatus_PreRender"
