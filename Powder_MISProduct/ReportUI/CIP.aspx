<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CIP.aspx.cs" Inherits="Powder_MISProduct.ReportUI.CIP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">CIP Log Report-C3F1</li>
        </ul>
    </div>
    <div class="col-md-12">
