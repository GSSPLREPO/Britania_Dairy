<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CPLLog.aspx.cs" Inherits="Powder_MISProduct.ReportUI.CPLLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">CPL Log Report</li>
        </ul>
    </div>
    <div class="col-md-12">
                     ...
                     <%--<asp:GridView runat="server" ID="gvCPL"
                        ...
                        HeaderStyle-Font-Size="Medium" CssClass="gvTheGrid striped" OnPreRender="gvCPL_PreRender">
                           ...
                           <Columns>
                            ...
                            <asp:BoundField DataField="Flow" HeaderText="Pasteurizer Flow(LPH)" ItemStyle-Wrap="false" />
