<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="ConcFeedTankStatus.aspx.cs" Inherits="Powder_MISProduct.ReportUI.ConcFeedTankStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">Conc. Feed Tank Status Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                       <asp:GridView ID="gvConcfeedTankStatus" runat="server" GridLines="Both" 
                        AutoGenerateColumns="true" HeaderStyle-Wrap="false"
                        Width="100%" ShowHeader="false"
                        OnRowCreated="gvConcfeedTankStatus_RowCreated" OnPreRender="gvConcfeedTankStatus_PreRender"
