<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="ROPermeateStatus.aspx.cs" Inherits="Powder_MISProduct.ReportUI.ROPermeateStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div id="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="active">RO Permeate Storage Status Report</li>
        </ul>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10" style="font-size: 24px;">
                       RO Permeate Storage Status Report
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                       <asp:GridView ID="gvROPermeateStorage" runat="server" GridLines="Both" 
                        AutoGenerateColumns="true" HeaderStyle-Wrap="false"
                        Width="100%" ShowHeader="false"
                        OnRowCreated="gvROPermeateStorage_RowCreated" OnPreRender="gvROPermeateStorage_PreRender"
